...
rem call code c:\gh\oomlout_oobb_version_4
rem call code c:\gh\oomlout_oobb_version_4_generated_parts
rem call code C:\gh\oomlout_oomp_part_generation_version_1
z:
...
start C:\od\OneDrive\docs\food_recipe_automation\working_web_oomp.py
